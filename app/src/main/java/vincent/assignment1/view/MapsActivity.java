...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int id = Integer.parseInt(getIntent().getStringExtra("trackid"));
    }
    /**
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        List<LatLng> routeLocationList = MyTrackerMapHelper.getINSTANCE().getRouteLocationList();
...
//        mMap.addMarker(new MarkerOptions().position(curLocation).title("I am trackable"));
        ...
        LatLng curLocation = new LatLng(-37.807425, 144.963814);
