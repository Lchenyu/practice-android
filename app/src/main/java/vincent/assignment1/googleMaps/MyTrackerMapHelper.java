...
//                int timeDiff = Math.abs(getDiff(MyTimeHelper.getMeasurableTime(currentTime), MyTimeHelper.getMeasurableTime(routeObj.getDate())));
//
//                timeDiffList.add(timeDiff);
//                Log.d(TAG_STAGE + getClass().getName(), "current time: " + currentTime.getTime() + "  route time: " + routeObj.getDate().getTime() + "  " + timeDiff);
//            }
//
...
//            }
//
//            Log.d(TAG_STAGE + getClass().getName(), "the closest object: " + routeList.get(index).getDate());
//
...
//    }
    ...
    //find all route info, it will show all locations on map
